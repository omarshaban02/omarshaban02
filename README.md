...
- Exploring research-oriented AI with real-world clinical relevance
...
- Video-based stereotypical behavior detection using **MViT + Detectron2**
- Audio & audiovisual reasoning with **Whisper + Vision-Language Models**
- Gaze and emotion tracking using **MediaPipe & DeepFace**
- Graphomotor and drawing analysis using **CNNs & classical ML**
- Screening using **Q-CHAT-based ensemble learning**
- Full-stack system using **Django + Next.js + Dockerized microservices**

> A complete AI-powered screening framework combining **video, audio, and behavioral signals** for healthcare applications.
...
- Research-oriented mindset with applied engineering skills
- Comfortable with **model deployment and production pipelines**
- Ability to bridge **engineering, AI, and biomedical domains**
